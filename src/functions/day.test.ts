...
describe('createDay', () => {
  ...
  describe('DayManager', () => {
    test('emptyDayManager', () => {
      expect(getEmptyDayManager().getDay().day).toBeUndefined()
    ...
    test('emptyDay', () => {
      ...
      expect(getEmptyDay().lunch).toBeUndefined()
      expect(getEmptyDay().name).toEqual('')
      expect(getEmptyDay().weekId).toEqual(0)
    })
    test('emptyDexie', () => {
      expect(getEmptyDexie().confirmedHour).toBeUndefined()
      expect(getEmptyDexie().dayStart).toBeUndefined()
      expect(getEmptyDexie().dayStop).toBeUndefined()
      expect(getEmptyDexie().plannedHour).toEqual(0)
      expect(getEmptyDexie().id).toBeUndefined()
      expect(getEmptyDexie().lunchStart).toBeUndefined()
      expect(getEmptyDexie().lunchStop).toBeUndefined()
